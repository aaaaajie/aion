...
description: Detect indirect prompt injection hidden in documents, web pages, webpages, images, PDFs, retrieved RAG context, and tool outputs consumed by an AI Agent. Use for indirect prompt injection, document injection, webpage injection, webpages, image injection, RAG poisoning, retrieved context, and untrusted content.
---

# Detecting Indirect Prompt Injection Skill
...
- the task mentions `detecting`
- the task mentions `indirect`
