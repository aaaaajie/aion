...
Fill `../references/variant-report-template.md` — the path is relative to this file, so
from the skill root it is `references/variant-report-template.md`. Every section earns its
place:
