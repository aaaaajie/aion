...
- the task mentions `variant`
- the task mentions `analysis`
- the task mentions `hunts`
- the task mentions `other`
...
**CodeQL** (`references/codeql/`): `python.ql`, `javascript.ql`, `java.ql`, `go.ql`, `cpp.ql`

**Semgrep** (`references/semgrep/`): `python.yaml`, `javascript.yaml`, `java.yaml`, `go.yaml`, `cpp.yaml`

**Report**: `references/variant-report-template.md`
