...
> **Load trigger**: When the agent needs a comprehensive catalog of LLM jailbreak techniques, multi-step escalation strategies, or specific bypass payloads. Assumes the main `SKILL.md` (resource: `SKILL.md`) is already loaded for conceptual understanding of prompt injection.
