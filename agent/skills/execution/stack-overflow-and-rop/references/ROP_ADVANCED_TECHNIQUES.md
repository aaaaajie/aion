...
> **AI LOAD INSTRUCTION**: Load this when you need Blind ROP methodology, ret2vdso for ASLR bypass, partial overwrite for PIE bypass, or alternative code-reuse paradigms (JOP/COP). Assumes the main `SKILL.md` (resource: `SKILL.md`) is already loaded for fundamental ROP, ret2csu, ret2dlresolve, and SROP.
