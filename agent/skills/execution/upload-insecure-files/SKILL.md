...
description: Insecure file upload playbook. Use when testing upload validation, storage paths, processing pipelines, preview behavior, overwrite risks, and upload-to-RCE chains.
---

# Upload Insecure Files Skill
...
- the task mentions `upload`
- the task mentions `insecure`
- the task mentions `files`
- the task mentions `file`
...
- `path traversal lfi` (related Skill; use `skill_list` to locate it) when filename, extraction path, or include path becomes file-system control
- [xss cross site scripting](C:/Users/Chengxiaoyu/.agents/skills/xss-cross-site-scripting/SKILL.md) when uploads are rendered in browser contexts
- [xxe xml external entity](C:/Users/Chengxiaoyu/.agents/skills/xxe-xml-external-entity/SKILL.md) when SVG, OOXML, or XML imports are accepted
- [cmdi command injection](C:/Users/Chengxiaoyu/.agents/skills/cmdi-command-injection/SKILL.md) when a processor, converter, or media pipeline executes system tools
- [business logic vulnerabilities](C:/Users/Chengxiaoyu/.agents/skills/business-logic-vulnerabilities/SKILL.md) when quotas, overwrite rules, approvals, or storage paths create logic bugs
...
| Observation | Pivot |
|---|---|
| SVG or XML accepted | [xxe xml external entity](C:/Users/Chengxiaoyu/.agents/skills/xxe-xml-external-entity/SKILL.md) |
| filename or metadata reflected | [xss cross site scripting](C:/Users/Chengxiaoyu/.agents/skills/xss-cross-site-scripting/SKILL.md) |
| converter or processor shells out | [cmdi command injection](C:/Users/Chengxiaoyu/.agents/skills/cmdi-command-injection/SKILL.md) |
| extraction path looks controllable | `path traversal lfi` (related Skill; use `skill_list` to locate it) |
| overwrite, quota, approval, or tenant bug | [business logic vulnerabilities](C:/Users/Chengxiaoyu/.agents/skills/business-logic-vulnerabilities/SKILL.md) |
