...
# Symbolic Execution Tools Skill
...
- the task mentions `symbolic`
- the task mentions `execution`
- the task mentions `tools`
- the task mentions `constraint`
...
- `vm-and-bytecode-reverse` (related Skill; use `skill_list` to locate it) when applying angr to custom VM challenges

### Advanced Reference

Also load [references/ANGR_COOKBOOK.md](references/ANGR_COOKBOOK.md) when you need:
