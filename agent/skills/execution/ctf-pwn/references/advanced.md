...
- [Kernel Exploitation](#kernel-exploitation) (basic; see `kernel.md` (resource: `references/kernel.md`) for full coverage)
...
**See also:** `heap-techniques.md` (resource: `references/heap-techniques.md`) — House of Apple 2, House of Einherjar, House of Orange/Spirit/Lore/Force, heap grooming, custom allocator exploitation (nginx, talloc), classic unlink, musl libc heap, tcache stashing unlink
...
See `rop-and-shellcode.md` (resource: `references/rop-and-shellcode.md#rdx-control-in-rop-chains`) for full details and code examples.
...
For comprehensive kernel exploitation techniques, see `kernel.md` (resource: `references/kernel.md`). Quick reference:
