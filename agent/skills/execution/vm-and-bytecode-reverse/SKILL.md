...
description: Custom VM and bytecode reverse engineering playbook. Use when CTF challenges
  or protected software implement custom virtual machines with proprietary bytecode,
  dispatcher loops, or maze-style challenges.
---

# Vm And Bytecode Reverse Skill
...
- the task mentions `bytecode`
- the task mentions `reverse`
- the task mentions `custom`
...
- `symbolic-execution-tools` (related Skill; use skill_list to locate it) when using angr to solve VM-based challenges
