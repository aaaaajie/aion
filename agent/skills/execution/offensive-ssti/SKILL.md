---
name: offensive-ssti
description: Server-side template injection and SSTI playbook for Jinja2, Twig, Freemarker, Pebble, Velocity, report export, template rendering, expression evaluation, engine fingerprinting, sandbox bypass, blind confirmation, and template-to-command-execution chains.
---

# Offensive Ssti Skill
...
- the task mentions `ssti`
- the task mentions `server`
- the task mentions `side`
- the task mentions `template`
