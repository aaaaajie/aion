---
name: ida-reverse
description: IDA Pro reverse engineering and binary vulnerability analysis for PE, ELF, APK, DLL, SO, Mach-O, firmware, decompile, decompilation, cross-references, cross references, strings, anti-debugging, password or key checks, and exploit-relevant behavior. Use for IDA, IDA Pro, reverse, reverse engineering, disassembly, decompile, decompilation, binary analysis, and native sample cases.
---
...
- the task mentions `ida`
- the task mentions `reverse`
- the task mentions `pro`
- the task mentions `elf`
