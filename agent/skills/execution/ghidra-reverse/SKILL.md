---
name: ghidra-reverse
description: Use for free/open reverse engineering with Ghidra (headless or GUI),
  including decompile, cross-refs, and optional Ghidra MCP workflows when IDA is unavailable.
---

# Ghidra Reverse Skill
...
- the task mentions `ghidra`
- the task mentions `reverse`
- the task mentions `use`
- the task mentions `free`
