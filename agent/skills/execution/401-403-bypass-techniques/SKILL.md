...
# 401 403 Bypass Techniques Skill
...
- `http-host-header-attacks` (related Skill; use `skill_list` to locate it) — Host header manipulation for routing bypass
- `request-smuggling` (related Skill; use `skill_list` to locate it) — smuggle past access controls entirely
