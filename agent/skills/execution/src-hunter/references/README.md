**中文** · `English` (resource: `references/README.en.md`)
...
**当前主选**：[jshookmcp](https://github.com/vmoranv/jshookmcp) 0.3.0（134 工具精选 / 386 全集 / 36 域），完整索引与场景映射见 ``references/tools/mcp-jshook.md`` (resource: `references/tools/mcp-jshook.md`)。
