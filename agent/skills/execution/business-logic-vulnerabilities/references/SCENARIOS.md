...
Already covered in `SKILL.md §2 Multi-Device Concurrent VIP Subscription` (resource: `SKILL.md`). Practical Burp recipe:
...
(Full URL-redirect bypass list in `CHECKLIST.md §11` (resource: `references/CHECKLIST.md`).)

---

## 14. IDOR / Authorization — Reproducible Drills

> Companion to `SKILL.md §11.6` (resource: `SKILL.md`) and `CHECKLIST.md §8` (resource: `references/CHECKLIST.md`).
...
> Companion to `SKILL.md §11.8` (resource: `SKILL.md`) and `CHECKLIST.md §16` (resource: `references/CHECKLIST.md`).
...
> Companion to `SKILL.md §11.9` (resource: `SKILL.md`) and `CHECKLIST.md §17` (resource: `references/CHECKLIST.md`).
