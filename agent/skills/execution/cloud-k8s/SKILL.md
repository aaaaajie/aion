---
name: cloud-k8s
description: Use for authorized cloud, container, and Kubernetes security assessment
...
Use when:
- the task mentions `cloud`
- the task mentions `k8s`
- the task mentions `use`
- the task mentions `authorized`
- the task mentions `container`
