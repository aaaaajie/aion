---
name: reverse-flow
description: Guided reverse engineering workflow for binaries, firmware, mobile apps,
  scripts, document samples, protocol captures, and unknown artifacts. Use when Codex
  is asked to perform reverse engineering, malware or suspicious-file analysis, static
  or dynamic analysis, decompilation planning, vulnerability discovery, exploitability
  assessment, root-cause analysis, patch diffing, firmware analysis, Android/iOS app
  analysis, or to produce analysis reports, deep reverse reports, evidence-backed
  vulnerability reports, user-intent recovery for ambiguous reverse-engineering requests,
  and user-selectable next-step plans.
---
...
- the task mentions `flow`
- the task mentions `guided`
