...
For core language reversing (Python, BF/esolangs, DOS, Unity, OPAL), see `languages.md` (resource: `references/languages.md`).
For Go and Rust binary reversing, see `languages-compiled.md` (resource: `references/languages-compiled.md`).
...
See `patterns-ctf-2.md` (resource: `references/patterns-ctf-2.md#prefix-hash-brute-force-nullcon-2026`) for the full technique. This section covers language-specific considerations.
