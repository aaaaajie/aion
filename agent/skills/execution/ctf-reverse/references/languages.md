...
For platform/framework-specific techniques (Android, Roblox, Godot, Electron, Node.js, Verilog, Ruby/Perl polyglot, etc.), see `languages-platforms.md` (resource: `references/languages-platforms.md`).
