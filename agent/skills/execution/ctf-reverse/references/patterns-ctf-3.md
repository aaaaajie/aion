...
See also: `patterns-ctf.md` (resource: `references/patterns-ctf.md`) for Part 1, `patterns-ctf-2.md` (resource: `references/patterns-ctf-2.md`) for Part 2 (multi-layer self-decrypting binary, embedded ZIP+XOR license, stack string deobfuscation, prefix hash brute-force, CVP/LLL lattice, decision tree obfuscation, GF(2^8) Gaussian elimination).
