...
**ARM64/AArch64:** See `platforms-hardware.md` (resource: `references/platforms-hardware.md#arm64aarch64-reversing-and-exploitation`) for AArch64 calling convention, ROP gadgets, and qemu-aarch64-static emulation.
...
**RISC-V:** See main `tools.md` (resource: `references/tools.md#risc-v-binary-analysis-ehax-2026`) for Capstone disassembly and `platforms-hardware.md` (resource: `references/platforms-hardware.md#risc-v-advanced`) for advanced extensions and debugging.
...
See `languages.md` (resource: `references/languages.md#unity-il2cpp-games`) for IL2CPP basics.
