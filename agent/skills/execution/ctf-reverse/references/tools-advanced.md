...
For advanced GDB scripting, Ghidra automation, patching frameworks, and GDB-driven CTF techniques, see `tools-advanced-2.md` (resource: `references/tools-advanced-2.md`).
