...
Advanced GDB scripting, Ghidra automation, patching frameworks, and CTF-specific GDB-driven techniques. Continuation of `tools-advanced.md` (resource: `references/tools-advanced.md`).
