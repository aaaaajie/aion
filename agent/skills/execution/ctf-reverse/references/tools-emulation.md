...
For core dynamic analysis tools (Frida, angr, lldb, x64dbg), see `tools-dynamic.md` (resource: `references/tools-dynamic.md`).
...
See `tools-advanced.md` (resource: `references/tools-advanced.md#triton-dynamic-symbolic-execution`) for full Triton reference. Quick usage:
