...
For malware patching, multi-stage shellcode loaders, timing/signal oracles, and CTF-specific runtime attacks (INT3 coredump oracle, signal handler chain, printf format string VM, quadtree image format), see `patterns-runtime.md` (resource: `references/patterns-runtime.md`).
...
See `patterns-runtime.md` (resource: `references/patterns-runtime.md`) for malware patching, multi-stage shellcode, timing/signal oracles, and CTF writeup techniques.
