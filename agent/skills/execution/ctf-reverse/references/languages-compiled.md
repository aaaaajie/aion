...
See `platforms.md` (resource: `references/platforms.md#swift-binary-reversing`) for full Swift reversing guide including demangling, runtime structures, and Ghidra integration. Key quick reference:
