---
name: ctf-reverse
description: Binary reverse engineering playbook for CTF compiled and obfuscated targets, packed native or managed programs, APK, WASM, firmware, custom VM and bytecode, anti-debugging, algorithm recovery, key checks, and behavior reconstruction before exploitation.
---
...
Use [references/field-notes.md](references/field-notes.md) after the first round of triage when you know what kind of target you have.
