...
description: WebSocket handshake, CSWSH, tooling (wsrepl, ws-harness, Burp), and common
  flaws. Use when apps use real-time channels, chat, notifications, or WS-backed APIs.
---
...
- the task mentions `websocket`
- the task mentions `security`
- the task mentions `handshake`
- the task mentions `cswsh`
