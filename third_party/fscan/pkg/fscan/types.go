...
type Config struct {
	...
	Plugins []string
	Ports   []int
	// DisablePlugins keeps host discovery, TCP port scanning and service-probe
	// identification enabled while preventing all registered plugins from being
	// dispatched. It takes precedence over Plugins.
	DisablePlugins bool
