...
class StealthWordGenerator:
    ...
    _onsets = ("l", "m", "n", "p", "r", "s", "t", "v", "c", "cl", "cr", "pl", "pr", "st", "tr", "vr")
    _nuclei = ("a", "e", "i", "o", "u", "ae", "ai", "ia", "io", "ou")
    _codas = ("l", "m", "n", "r", "s", "t", "v", "c", "nt", "rn", "st")
    _suffixes = ("al", "an", "ar", "en", "ic", "in", "or", "um", "ian", "ion", "ium", "ora", "ory")
    ...
    def _pseudo_word(self, min_length: int, max_length: int) -> str:
        for _ in range(100):
            ...
            if self._rng.random() < 0.75:
                pieces.extend((self._rng.choice(self._onsets), self._rng.choice(self._nuclei)))
